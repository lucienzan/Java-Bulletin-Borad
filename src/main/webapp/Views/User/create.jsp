			...
			<form action="<%= request.getContextPath()+"/user-create" %>" method="Post" enctype="multipart/form-data" class="g-3 ">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <span class="text-danger fw-bold">*</span>
                        <input required type="number" name="phone" value="${ user.getPhone() }" class="form-control rounded ${not empty requestScope.phoneError ? 'is-invalid' : ''}" placeholder="09123456789" id="phone">
